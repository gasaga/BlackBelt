...
import techniques from '../techniques/tecnicas-amarillo.js';
...
export default [
  generateQuestion(techniques.montongAnMaki),
  generateQuestion(techniques.montongBandeJirugui),
  generateQuestion(techniques.montongBaroJirugui),
  generateQuestion(techniques.chariotSogui),
  generateQuestion(techniques.apKubiSogui),
  generateQuestion(techniques.kibonChumbi),
  generateQuestion(techniques.dolioChagui),
  generateQuestion(techniques.yopChagui),
  // ... más técnicas
