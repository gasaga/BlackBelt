...
import techniques from '../techniques/tecnicas-blanco.js';
...
export default [
  generateQuestion(techniques.areMaki),
  generateQuestion(techniques.montongMaki),
  generateQuestion(techniques.olgulMaki),
  generateQuestion(techniques.apSogui),
  generateQuestion(techniques.apChagui),
  generateQuestion(techniques.montongJirugui),
  // ... más técnicas
